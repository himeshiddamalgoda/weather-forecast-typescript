...
const Search = ({term,options,onInputChange,onOptionSelect,onSubmit}:Props): JSX.Element => {
  ...
  return (
    <main className="flex justify-center items-center bg-gradient-to-br from-sky-400 via-sky-200 to-white h-[100vh] w-full">
      <section className="w-full md:max-w-[500px] p-4 flex flex-col text-center items-center justify-center md:px-10 lg:p-24 h h-full lg:h-[500px] bg-white bg-opacity-20 backdrop-blur-lg text-zinc-700">
